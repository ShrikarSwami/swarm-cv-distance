...
import sys
os.path.join(os.path.dirname(__file__), 'stage1_geometry')
import sys
os.path.join(os.path.dirname(__file__), 'stage1_geometry')
...
print(f"1. DEFAULT_FOCAL_PX from data_contract: {DEFAULT_FOCAL_PX:.2f}")
...
transcript, rig_default, pixel_noise_std=0.5, drop_prob=0.0, seed=1
)
...
transcript, rig_custom, pixel_noise_std=0.5, drop_prob=0.0, seed=2
)
